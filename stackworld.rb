...
post '/create_room' do
  # Capture all the params hash into variables
  room_name = params[:name]
  room_description = params[:description]
  background_image = params[:background_image]

  # create the room and save the created instance into "room"
  room = Room.create(:name => room_name, :description => room_description, :background_image => background_image)

  # redirect the user to the room that was just created
